...
class InvoiceTest extends TestCase
{
    ...
    function test_create_a_invoice()
    {
        ...
        $this->postJson('/api/invoice', $params)
            ->assertStatus(201)
            ->assertJson([
                'data' => [
                    'status' => 'Creado'
    ...
    public function test_store_invoice_detail()
    {
        $this->withoutExceptionHandling();
        $user =  $this->defaultUser();
        $this->actingAs($user, 'api');
    ...
    public function test_destroy_invoice_detail()
    {
        $this->withoutExceptionHandling();
        $user =  $this->defaultUser();
        $this->actingAs($user, 'api');
    ...
    public function test_store_with_2_stoks_invoice_detail()
    {
        $this->withoutExceptionHandling();
        $user =  $this->defaultUser();
        $this->actingAs($user, 'api');
    ...
    public function test_destroy_invoice_detail_with_2_stoks()
    {
        $this->withoutExceptionHandling();
        $user =  $this->defaultUser();
        $this->actingAs($user, 'api');
