{!! Field::text('name', ['template' => '']) !!}
{!! Field::textarea('description', ['template' => '', 'rows' => 2]) !!}
<div class="row">
    <div class="col-xs-12 col-md-6">
        {!! Field::select('category_id', $categories, ['template' => '']) !!}
    </div>
    <div class="col-xs-12 col-md-6">
        {!! Field::select('product_group_id', $groups, ['template' => '']) !!}
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-md-6">
        {!! Field::select('product_serie_id', $product_series, ['template' => '']) !!}
    </div>
    <div class="col-xs-12 col-md-6">
        {!! Field::select('unit_measure_id', $units, ['template' => '']) !!}
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-md-6">
        {!! Field::select('make_id', $makes, ['template' => '']) !!}
    </div>
    <div class="col-xs-12 col-md-6">
        {!! Field::select('product_presentation_id', $presentations, ['template' => '']) !!}
    </div>
</div>
